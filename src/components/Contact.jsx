...
const contactInfo = [
  {
    title: "Address",
    desc: "BharatCraft Cultural & Artisan Support Center, New Delhi, India"
  },
  {
    title: "Phone",
    desc: "+91 9442482810"
  ...
  <div className="container-fluid">
    ...
    <section className="py-5 bg-light">
      <Container>
        ...
        <p className="text-center text-muted mb-5" style={{ maxWidth: 600, margin: "0 auto" }}>
          We’d love to hear from you! Whether you have questions about our products,
          artisan partnerships, or custom orders — we’re here to help.
        </p>
            ...
            <Card className="shadow-sm border-0">
              <Card.Body>
                <Form>
                  ...
                  <Button variant="primary" className="w-100" style={{ background: "#e77f34", border: "none" }}>
                    Send Message
                  </Button>
                </Form>
              </Card.Body>
